classdef MitometerAppApp < handle
    %
    % Usage:
    %     app.MitometerAppApp
    ...
    properties (Constant)
        AppPathBase = {'/MitometerApp'};
        AppClass = 'MitometerAppApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            MitometerAppApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'GUI2')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong GUI2
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'GUI2').getString, ...
